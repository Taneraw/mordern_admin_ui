        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            <li><i class="fa fa-home"></i><a href="slider_list.php">Slider List</a></li>s
                            <li style="float:right;"><i class="fa fa-laptop"></i><a href="slider.php">Add Slider</a>
                            </li>
                        </ol>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!-----         <?php if (
                                          ...
                                          echo "<a href='slider_active_status_change.php?id=" .
                                            $row[$i]['id'] .
                                            "&status=0' >ON</a>";
                                        } else {
                                          echo "<a href='slider_active_status_change.php?id=" .
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a class="btn btn-success" href="slider.php?id=<?php echo $row[
                                                  $i
                                                ]['id']; ?>">Edit</a>
