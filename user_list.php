        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            <li><i class="fa fa-home"></i><a href="mastercategory_list.php">Master Category List</a>
                            </li>
                            <li style="float:right;"><i class="fa fa-laptop"></i><a href="mastercategory.php">Add
                                    Master Category</a>
                            </li>
                        </ol>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if (
                                              ...
                                              echo "<a href='mastercategory_active_status_change.php?id=" .
                                                $row[$i]['id'] .
                                                "&status=0' >ON</a>";
                                            } else {
                                              echo "<a href='mastercategory_active_status_change.php?id=" .
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a class="btn btn-success" href="mastercategory.php?id=<?php echo $row[
                                                  $i
                                                ]['id']; ?>">Edit</a>
